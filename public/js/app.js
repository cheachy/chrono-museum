// Main App - Orchestrates the application and handles time travel/warp effects
const App = {
  isWarping: false,
  ...
  init: function() {
    ...
    // Debug: Log if DB is available
    if (typeof window.DB !== 'undefined') {
      console.log("✅ data.js loaded successfully! DB object available.");
      console.log("Available eras:", Object.keys(window.DB));
    } else if (typeof DB !== 'undefined') {
      console.log("✅ data.js loaded successfully! DB (const) available.");
      console.log("Available eras:", Object.keys(DB));
    } else {
      console.error("❌ data.js not loaded! DB object not found.");
    }
  },
  ...
  // Enter the experience (called from start button)
...
// Expose DataService for configuration
